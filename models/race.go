...
type Race struct {
	...
	BandStart      *int    `bun:"band_start" json:"bandStart,omitempty"`
	BandEnd        *int    `bun:"band_end" json:"bandEnd,omitempty"`
	AgeRestriction *string `bun:"age_restriction" json:"ageRestriction,omitempty"`
